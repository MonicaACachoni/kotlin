...
//import Malha.Malha;
//
//public class TremMonica implements Comparable<TremMonica> {
//
//	// public static int headway = 60;
//
//	private String nome;
//	private int destino; 
//	private int custo; // custo unidade do trem
...
//
//	
//	public static Vector<TremMonica> loadFromFile(String arquivo, Malha M, String custos) throws IOException {
//
//		Vector<TremMonica> T = new Vector<TremMonica>();
//
//		/*
...
//			Custos cT = TremMonica.loadCostsFromFile(custos,nome);
//						
//			TremMonica t = new TremMonica(nome, (int) s.nextInt(), (int) s.nextInt(), (int) s.nextInt(), (int) s.nextInt(),
...
//
//		//nomeTrem custoParada custoManterParadoNaEstaçãoPorMinuto default duplas(Estacao,Custo)
//	    	Custos custosDoTrem ;
//	    	int custoDeParada = 0;
//	    	int custoParado = 0;
//	    	int custoDefault = 0;
...
//
//	
//	public TremMonica(String nome, int inicioTrecho, int fimTrecho, int distanciaInicioTrecho, 
...
//	}
//
//	public int compareTo(TremMonica that) {
